 ...
 */
class DeviceSpecViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private suspend fun collectHardwareInfo(): Map<String, Any> {
        ...
        hardwareInfo["supported_abi"] = Build.SUPPORTED_ABIS.toList()
        hardwareInfo["supported_32_bit_abi"] = Build.SUPPORTED_32_BIT_ABIS.toList()
        hardwareInfo["supported_64_bit_abi"] = Build.SUPPORTED_64_BIT_ABIS.toList()
    ...
    private suspend fun collectSystemInfo(): Map<String, Any> {
        ...
        systemInfo["android_version"] = Build.VERSION.RELEASE ?: "unknown"
        systemInfo["android_sdk_int"] = Build.VERSION.SDK_INT
        systemInfo["android_codename"] = Build.VERSION.CODENAME ?: "unknown"
        systemInfo["android_incremental"] = Build.VERSION.INCREMENTAL ?: "unknown"
        systemInfo["android_security_patch"] = Build.VERSION.SECURITY_PATCH ?: "unknown"

        // Settings information
        try {
            systemInfo["android_id"] = Settings.Secure.getString(context.contentResolver, Settings.Secure.ANDROID_ID) ?: "unknown"
        } catch (e: Exception) {
            systemInfo["android_id"] = "unknown"
        }
    ...
    private suspend fun collectNetworkInfo(): Map<String, Any> {
        ...
        try {
            ...
            networkInfo["network_type"] = activeNetwork?.type ?: -1
            networkInfo["network_subtype"] = activeNetwork?.subtype ?: -1
        } catch (e: Exception) {
            networkInfo["network_available"] = false
            networkInfo["network_error"] = (e.message ?: "unknown")
        }
        ...
        try {
            ...
            networkInfo["wifi_enabled"] = false
        }
        ...
        try {
            ...
            networkInfo["bluetooth_enabled"] = false
        }
