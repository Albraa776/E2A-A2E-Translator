...
dependencies {
    ...
    // MultiDex for large number of dependencies
    ...
    // Room for database (optional for caching)
    implementation("androidx.room:room-runtime:2.6.1")
    implementation("androidx.room:room-ktx:2.6.1")
    ksp("androidx.room:room-compiler:2.6.1")
    
    // CameraX for camera information
    ...
    // Sensor fusion (optional for advanced sensor processing)
    implementation("org.sensorlab.sensorlog:sensorlog:1.0.0")
